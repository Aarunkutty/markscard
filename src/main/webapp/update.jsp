...
<body>
	...
	<form action="update" id="insertbutton">
		<table>
			<tr>
				<td><label>Register Number :</label></td>
				<td><input type="number" name="register" readonly="readonly" value=<% %>
			...
			<tr>
				...
				<td><input type="number" name="internal_kannada_mark"
			...
			<tr>
				...
				<td><input type="number" name="internal_english_mark"
			...
			<tr>
				...
				<td><input type="number" name="internal_hindi_mark"
			...
			<tr>
				...
				<td><input type="number" name="internal_math_mark"
			...
			<tr>
				...
				<td><input type="number" name="internal_science_mark"
			...
			<tr>
				...
				<td><input type="number" name="internal_social_science_mark"
			...
			<tr>
				...
				<td><input type="number" name="external_kannada_mark"
					required="required" placeholder="Enter Kannada Mark"
			...
			<tr>
				...
				<td><input type="number" name="external_english_mark"
					required="required" placeholder="Enter English Mark"
			...
			<tr>
				...
				<td><input type="number" name="external_hindi_mark"
					required="required" placeholder="Enter Hindi Mark"
			...
			<tr>
				...
				<td><input type="number" name="external_math_mark"
					required="required" placeholder="Enter Math Mark"
			...
			<tr>
				...
				<td><input type="number" name="external_science_mark"
					required="required" placeholder="Enter Science Mark"
			...
			<tr>
				...
				<td><input type="number" name="external_social_science_mark"
					required="required" placeholder="Enter Social Science Mark"
			...
			<tr>
				...
				<td><select name="physical" required="required"
			...
			<tr>
				<td><label>Attitude Values :</label></td>
				<td><select name="attitude" required="required"
			...
			<tr>
				...
				<td><select name="work" required="required"
			...
			<tr>
				<td><label>Art Education :</label></td>
				<td><select name="art" required="required"
			...
			<tr>
				<td id="sub"><button form="insertbutton" type="submit">Submit</button></td>
				<td id="sub2"><a href="index.jsp"><button id="butt2">Cancel</button></a></td>
			</tr>
		</table>
	</form>
